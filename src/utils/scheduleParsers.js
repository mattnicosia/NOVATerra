...
export const SCHEDULE_TYPES = [
  ...
  },
  {
    ...
    outputFields: ["mark", "width", "height", "type", "material", "frame", "hardware", "fire_rating"],
    csiDivisions: ["08"],
  },
  {
    id: "window",
    ...
    outputFields: ["mark", "width", "height", "type", "glazing", "frame", "operation"],
    csiDivisions: ["08"],
  },
  {
    id: "finish",
  ...
  },
  {
    ...
    outputFields: ["mark", "fixture_type", "manufacturer", "model", "supply", "waste"],
    csiDivisions: ["22"],
  },
  {
    id: "equipment",
    ...
    outputFields: ["mark", "description", "size", "electrical", "plumbing", "mechanical"],
    csiDivisions: ["11"],
  },
  {
    id: "lighting-fixture",
    ...
    outputFields: ["mark", "description", "lamp_type", "wattage", "voltage", "mounting", "dimming", "emergency", "circuit"],
    csiDivisions: ["26"],
  },
  {
    ...
    outputFields: ["mark", "description", "type", "capacity_tons_cfm", "voltage", "phase", "refrigerant", "ductwork", "controls"],
    csiDivisions: ["23"],
  },
  {
    id: "finish-detail",
