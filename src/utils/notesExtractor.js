 ...
 *
 * @param {{ imgBase64: string, ocrText: string, sheetLabel: string, apiKey: string }} opts
 * @returns {{ notes: Array, sheetSummary: string }}
 */
export async function extractDrawingNotes({ imgBase64, ocrText, sheetLabel, apiKey }) {
  if (!apiKey || !imgBase64) return { notes: [], sheetSummary: '' };
