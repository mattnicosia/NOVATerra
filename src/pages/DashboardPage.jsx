...
export default function DashboardPage() {
  ...
  if (showOnboarding) {
    const steps = [
      ...
      { icon: I.database, label: "Cost Database", desc: "Review pre-loaded cost items or add your own pricing data.", done: step2Done, action: () => navigate("/database"), color: C.green },
      ...
      <div style={{ ...card(C), overflow: "hidden" }}>
        ...
        <div style={{ padding: `${T.space[3]}px ${T.space[4]}px`, borderBottom: `1px solid ${C.border}`, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: T.space[3] }}>
            <span style={{ fontSize: T.fontSize.md, fontWeight: T.fontWeight.semibold, color: C.text }}>Estimates</span>
        ...
        {filtered.length === 0 ? (
          ...
          <div>
            {/* Column headers */}
            <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr 80px", padding: `${T.space[2]}px ${T.space[4]}px`, background: C.bg2, borderBottom: `1px solid ${C.border}`, ...sectionLabel(C) }}>
              <span>Name</span>
              <span>Client</span>
              <span>Status</span>
            ...
            {filtered.map((est, idx) => (
              ...
              >
                <span style={{ fontSize: 13, fontWeight: 500, color: C.text }}>{est.name || "Untitled"}</span>
