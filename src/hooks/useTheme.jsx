...
export function ThemeProvider({ children }) {
  ...
  const brandPalettes = useMasterDataStore(s => s.masterData?.companyInfo?.palettes);

  const value = useMemo(() => {
    const allPalettes = [...PALETTES, ...(customPalettes || []), ...(brandPalettes || [])];
  ...
  }, [selectedPalette, customPalettes, brandPalettes]);
