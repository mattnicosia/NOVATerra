...
// v11.5b: TRUE BLUE STAR palette — blue is DOMINANT, violet is a subtle undertone.
// R base 0.06 + swing 0.04 → max R ≈ 0.10, min R ≈ 0.02. Almost no red.
// Real blue stars (Rigel, Vega): overwhelmingly blue with faint violet undertone.
// B base 0.56 + swing 0.32 → rich range from deep indigo (0.24) to bright blue (0.88).
// G swing 0.12 → creates blue-teal zones for visual variety without purple.
const NOVA_PAL = {
  a: new THREE.Vector3(0.06, 0.08, 0.56), // very low R, moderate G, dominant B
  b: new THREE.Vector3(0.04, 0.12, 0.32), // minimal R swing, G for teal, wide B
