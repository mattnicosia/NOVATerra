...
export default function NovaSignInSplash({ onComplete, onTransitionStart }) {
      ...
      setLines([
        {
          ...
          text: greeting,
          style: textStyle,
          voiceOpts: VOICE_PRESETS[S.greeting.greetLine.voice],
        },
      ]);
    ...
    later(() => {
      setLines(prev => [
        ...prev.map(l => ({ ...l, done: true })),
        {
          key: nextKey(),
          lineId: "wait",
          text: S.greeting.waitingLine.text,
          style: textStyle,
          voiceOpts: VOICE_PRESETS[S.greeting.waitingLine.voice],
        },
      ]);
  ...
  const handleBriefingMainDone = useCallback(() => {
    ...
    later(() => {
      ...
      setLines(prev => [...prev.map(l => ({ ...l, done: true })), ...dayLines]);
      ...
      setLines([
        {
          key: nextKey(),
          lineId: "no-bids",
          text: S.briefingNone.noBidsLine.text,
          style: textStyle,
          voiceOpts: VOICE_PRESETS[S.briefingNone.noBidsLine.voice],
        },
      ]);
    ...
    later(() => {
      setLines(prev => [
        ...prev.map(l => ({ ...l, done: true })),
        {
          key: nextKey(),
          lineId: "clear",
          text: S.briefingNone.clearLine.text,
          style: textStyle,
          voiceOpts: VOICE_PRESETS[S.briefingNone.clearLine.voice],
        },
      ]);
