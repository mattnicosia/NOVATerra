      ...
      <div style={{ display: "flex", gap: 4, padding: "8px 12px", borderBottom: `1px solid ${C.border}` }}>
        {[
          ...
          <button key={t.key} onClick={() => setTab(t.key)}
            style={{ flex: 1, padding: "6px 4px", fontSize: 11, fontWeight: 600, border: "none", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", background: tab === t.key ? `${t.color}15` : "transparent", color: tab === t.key ? t.color : C.textDim, borderRadius: 6, transition: "all 0.15s" }}>
            {t.label} {t.count > 0 && <span style={{ background: `${t.color}25`, padding: "1px 5px", borderRadius: 8, fontSize: 10, marginLeft: 3 }}>{t.count}</span>}
          </button>
        ))}
      </div>
