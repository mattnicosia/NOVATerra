  ...
  return (
    <Modal onClose={onClose} extraWide>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ flex: 1 }}>
          <h3 style={{ color: C.text, fontSize: 16, fontWeight: 600, margin: 0 }}>Proposal Comparison</h3>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12 }}>
                ...
                >
                  ...
                  >
                    ...
                    {sub.exclusionCount > 0 && (
                      <span style={{ color: "#FF9F0A", fontSize: 10 }}>{sub.exclusionCount} excl</span>
                    )}
                  </div>
                </th>
              ))}
          ...
          <tbody>
            ...
            <tr style={{ borderTop: `2px solid ${C.border}` }}>
              <td style={{ padding: "10px", color: C.text, fontWeight: 700, fontSize: 13 }}>Total Bid</td>
            ...
            {/* Exposure Row */}
            <tr>
              <td style={{ padding: "6px 10px", color: C.textMuted, fontSize: 12 }}>Scope Exposure</td>
              <td style={{ padding: "6px 10px" }} />
              {subColumns.map((sub, i) => (
                <td key={i} style={{ padding: "6px 10px", textAlign: "center" }}>
                  {sub.totalExposure > 0 ? (
                    <span style={{ color: "#FF453A", fontSize: 12, fontWeight: 600 }}>+{fmt(sub.totalExposure)}</span>
                  ) : (
            ...
            <tr style={{ background: "rgba(124,92,252,0.04)" }}>
              <td style={{ padding: "10px", color: C.accent, fontWeight: 700, fontSize: 13 }}>Adjusted Cost</td>
              <td style={{ padding: "10px", textAlign: "right", color: C.textDim, fontSize: 11 }}>Bid + Exposure</td>
              {subColumns.map((sub, i) => (
                <td key={i} style={{ padding: "10px", textAlign: "center" }}>
                  <div
                    style={{
