        ...
        <div style={{ padding: "0 16px 14px", borderTop: `1px solid ${C.border}` }}>
          ...
          <div style={{ marginTop: 10 }}>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "60px 2fr 40px 70px 70px 70px 80px",
                gap: 6,
                marginBottom: 4,
                fontSize: 8,
                fontWeight: 600,
            ...
            {asm.elements.map((el, i) => {
              ...
              return (
                ...
                >
                  ...
                  <span style={{ textAlign: "right", fontFamily: T.font.sans, color: C.green }}>
                    {fmt2(nn(el.m) * nn(el.factor))}
                  </span>
                  <span style={{ textAlign: "right", fontFamily: T.font.sans, color: C.blue }}>
                    {fmt2(nn(el.l) * nn(el.factor))}
                  </span>
