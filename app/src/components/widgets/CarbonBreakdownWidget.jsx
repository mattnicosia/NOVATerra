...
const DIVISION_LABELS = {
  '03': 'Concrete', '04': 'Masonry', '05': 'Metals', '06': 'Wood/Framing',
  '07': 'Thermal', '08': 'Openings', '09': 'Finishes', '15': 'Mechanical',
  '16': 'Electrical', '21': 'Fire Supp.', '22': 'Plumbing', '23': 'HVAC',
  '26': 'Electrical', '31': 'Earthwork', '32': 'Exterior', '33': 'Utilities',
};
  ...
  const { carbonRows, totalCO2e } = useMemo(() => {
    ...
    const rows = entries.map(e => {
      ...
      return {
        ...
        value: e.kgCO2e, bar: maxVal > 0 ? e.kgCO2e / maxVal : 0,
