  ...
  return (
    <div style={{
      ...
      <div ref={ref} style={{
        ...
        <div style={{
          fontSize: 10, fontWeight: 400, color: C.textDim, marginBottom: 16,
          fontFamily: T.font.display,
        }}>
          Replacing <span style={{ fontWeight: 600, color: C.text }}>{currentReg.label || currentType}</span> — same position & size
        </div>
                ...
                <div style={{
                  ...
                  {catId === 'core' && (
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                      <path d="M1 9h10M3 9V5l3-2.5L9 5v4" stroke={catColor} strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  )}
                  {catId === 'market' && (
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                      <path d="M1 9l3-3 2 1.5L11 3M11 3v2.5M11 3H8.5" stroke={catColor} strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  )}
                  {catId === 'thirdparty' && (
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                    ...
                    <div key={w.typeId} style={{
                      ...
                      {alreadyActive ? (
                        <span style={{
                          ...
                          borderRadius: 5, background: ov(0.04),
                        }}>In Use</span>
                      ) : (
                        <button
