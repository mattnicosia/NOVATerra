...
const MARKET_DATA = {
  Materials: {
    MoM: [
      {
        label: "Concrete \u00b7 NYC Metro",
        value: "$188",
        unit: "/CY",
        sub: "Ready-mix 4000 PSI",
        badge: "\u25b2 1.4%",
        trend: "up",
      },
      {
        label: "Steel \u00b7 HSS Tube",
        value: "$0.84",
        unit: "/lb",
        sub: "Commodity market",
        badge: "\u25bc 0.3%",
        trend: "down",
      },
      {
        label: "Lumber \u00b7 2x4 SPF",
        value: "$0.42",
        unit: "/LF",
        sub: "Framing grade",
        badge: "\u25b2 0.8%",
  ...
  Labor: {
    MoM: [
      {
        label: "Carpenter \u00b7 Journeyman",
        value: "$92",
        unit: "/hr",
        sub: "BLS prevailing wage",
        badge: "\u25b2 0.4%",
        trend: "up",
      },
      {
        label: "Electrician \u00b7 Journeyman",
        value: "$108",
        unit: "/hr",
        sub: "IBEW scale",
        badge: "\u25b2 0.6%",
      ...
      {
        label: "Laborer \u00b7 General",
        value: "$62",
        unit: "/hr",
        sub: "Davis-Bacon rate",
        badge: "\u25b2 0.2%",
        trend: "up",
      },
    ],
