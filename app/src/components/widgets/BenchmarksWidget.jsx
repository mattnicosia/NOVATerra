      ...
      <div style={{ flex: 1 }}>
        {rows.map((b, i) => (
          <div key={i} style={{
            ...
            <span style={{ fontSize: 10, fontWeight: 400, color: C.textMuted, fontFamily: font, flex: 1, minWidth: 0 }}>{b.label}</span>
            <div style={{
              width: 36, height: 2, borderRadius: 1, background: ov(0.06),
            ...
            <span style={{ fontSize: 11, fontWeight: 600, color: b.color, fontFamily: font, minWidth: 28, textAlign: 'right' }}>{b.value}</span>
          </div>
        ))}
      </div>
    </div>
