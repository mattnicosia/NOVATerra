...
export default function WidgetPickerModal({ onClose }) {
  ...
  const inputStyle = {
    ...
    fontFamily: T.font.display, outline: 'none',
  ...
  return (
    <div style={{
      ...
      <div ref={ref} style={{
        ...
        <div style={{
          fontSize: 13, fontWeight: 600, color: C.text, marginBottom: 16,
        ...
        {configFor ? (
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: 8, justifyContent: 'flex-end', marginTop: 16 }}>
              <button onClick={() => setConfigFor(null)} style={{
              ...
              <button onClick={handleConfigSubmit} style={{
              ...
              <div key={catId} style={{ marginBottom: 20 }}>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    background: catId === 'core' ? `${C.accent}1A`
                      : catId === 'market' ? `${C.green || '#34D399'}1A`
                      : ov(0.06),
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    flexShrink: 0,
                  }}>
                    {catId === 'core' && (
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path d="M1 9h10M3 9V5l3-2.5L9 5v4" stroke={C.accent} strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    )}
                    {catId === 'market' && (
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path d="M1 9l3-3 2 1.5L11 3M11 3v2.5M11 3H8.5" stroke={C.green || '#34D399'} strokeWidth="1.1" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    )}
                    {catId === 'thirdparty' && (
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  ...
                  <div>
                    <div style={{
                      ...
                      fontFamily: T.font.display, lineHeight: 1.2,
                    }}>{catMeta.label}</div>
                    {catMeta.description && (
                      <div style={{
                        fontSize: 9, fontWeight: 400, color: C.textDim,
                        fontFamily: T.font.display, lineHeight: 1.2,
                      }}>{catMeta.description}</div>
                    )}
                  </div>
                </div>
                    ...
                    return (
                      <div key={w.typeId} style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{
                            fontSize: 9, fontWeight: 400, color: C.textDim,
                            fontFamily: T.font.display, marginTop: 2,
                          }}>{w.description}</div>
                        </div>
                        {isAdded ? (
                          <span style={{
                            fontSize: 9, fontWeight: 500, color: C.green,
                            fontFamily: T.font.display, padding: '3px 8px',
                            borderRadius: 5, background: `${C.green}1A`,
                          }}>Added</span>
                        ) : (
                          <button
