...
import { WIDGET_REGISTRY, SIZE_PRESETS, getAvailablePresets, getCurrentPreset } from "@/constants/widgetRegistry";
    ...
    >
      ...
      >
        <svg width="12" height="12" viewBox="0 0 12 12" fill="none" style={{ flexShrink: 0 }}>
          <path
            d="M6 1L6 11M1 6L11 6M6 1L4.5 2.5M6 1L7.5 2.5M6 11L4.5 9.5M6 11L7.5 9.5M1 6L2.5 4.5M1 6L2.5 7.5M11 6L9.5 4.5M11 6L9.5 7.5"
            stroke="currentColor"
            strokeWidth="1"
            strokeLinecap="round"
          />
      ...
      {onReplace && (
        ...
        >
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none" style={{ flexShrink: 0 }}>
            <path
              d="M10 3.5H4.5a2 2 0 000 4H6M2 8.5h5.5a2 2 0 000-4H6"
              stroke="currentColor"
              strokeWidth="1"
              strokeLinecap="round"
            />
            <path
              d="M8.5 1.5L10.5 3.5 8.5 5.5M3.5 6.5L1.5 8.5 3.5 10.5"
              stroke="currentColor"
              strokeWidth="1"
              strokeLinecap="round"
      ...
      {reg.configFields && onConfigure && (
        <button
          onClick={() => {
            onConfigure(widgetId, widgetType);
            onClose();
          }}
          style={menuItemStyle}
          onMouseEnter={e => (e.currentTarget.style.background = hoverBg)}
      ...
      {reg.removable !== false && (
        <>
          ...
          <button
            ...
            onMouseEnter={e =>
              (e.currentTarget.style.background = dk ? "rgba(255,59,48,0.08)" : "rgba(255,59,48,0.06)")
            }
            onMouseLeave={e => (e.currentTarget.style.background = "transparent")}
          >
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" style={{ flexShrink: 0 }}>
