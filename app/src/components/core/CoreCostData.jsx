...
export default function CoreCostData() {
  ...
  const userElements = useMemo(() => elements.filter(e => !e.id?.startsWith("s")), [elements]);
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {groupedByTrade.length > 0 ? (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <svg
                    ...
                    strokeLinecap="round"
                    style={{
                      transform: expandedTrade === trade ? "rotate(90deg)" : "rotate(0deg)",
                ...
                <span style={{ fontSize: 11, color: C.textDim, fontFamily: T.font.sans }}>
              ...
              {expandedTrade === trade && (
                <div style={{ borderTop: `1px solid ${C.border}` }}>
                  ...
                  <div
                    style={{
                      display: "grid",
                      gridTemplateColumns: "80px 1fr 60px 80px 80px 80px",
                      padding: "6px 16px",
                      gap: 8,
                      fontSize: 9,
                      fontWeight: 600,
                  ...
                  {items.map(el => (
                    ...
                    >
                      <span style={{ color: C.textMuted, fontFamily: T.font.sans, fontSize: 10.5 }}>
                        {el.code || "—"}
                      </span>
                      ...
                      <span style={{ textAlign: "right", fontFamily: T.font.sans, fontSize: 10.5 }}>
                        ${nn(el.material)}
                      </span>
                      <span style={{ textAlign: "right", fontFamily: T.font.sans, fontSize: 10.5 }}>
                        ${nn(el.labor)}
        ...
        >
          ...
          <h3 style={{ fontSize: 14, fontWeight: 600, color: C.text, margin: "0 0 6px" }}>No user cost data yet</h3>
