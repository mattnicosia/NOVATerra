  ...
  return (
    <div style={{
      ...
      <div>
        ...
        <p style={{ fontSize: 10.5, color: C.textDim, margin: "2px 0 0", lineHeight: 1.4 }}>
          {description}
        </p>
      </div>
    </div>
...
export default function CoreSources() {
  ...
  const stats = useMemo(() => {
    ...
    return { userElements: userElements.length, seedElements: seedElements.length, assemblies: assemblies.length, proposals: proposals.length, drawingsWithNotes: drawingsWithNotes.length, totalNotes };
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div>
        ...
        <p style={{ fontSize: 11.5, color: C.textMuted, margin: 0 }}>
          NOVA automatically learns from your data. Every element, proposal, and drawing note is embedded for semantic intelligence.
        </p>
      </div>
      ...
      {/* Coming Soon */}
      <div>
        <h3 style={{ fontSize: 12, fontWeight: 600, color: C.textDim, margin: "8px 0 10px", textTransform: "uppercase", letterSpacing: "0.06em" }}>
          Coming Soon
        </h3>
