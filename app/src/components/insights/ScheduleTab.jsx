  ...
  if (!generated && !generating && items.length === 0) {
    return (
      <div style={{ ...card(C), padding: T.space[8], textAlign: "center" }}>
        ...
        <div style={{ fontSize: T.fontSize.lg, color: C.textMuted, marginTop: T.space[4] }}>No estimate items yet</div>
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 160px)", gap: T.space[3] }}>
      ...
      >
        ...
        >
          <Ic
            d={I.refresh || "M23 4v6h-6 M1 20v-6h6 M3.51 9a9 9 0 0114.85-3.36L23 10 M1 14l4.64 4.36A9 9 0 0020.49 15"}
            size={12}
            color={C.textMuted}
          />
          Rebuild
