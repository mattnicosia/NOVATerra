...
const DIVISION_STYLES = {
  ...
  "06": {
    label: "Wood/Framing",
    gradient: "linear-gradient(90deg, #92400E, #F59E0B)",
    ...
    >
      ...
      <div style={{ marginTop: 20, textAlign: "center", maxWidth: 480, width: "100%" }}>
        ...
        >
          ...
          {formatted.dollars}
          <span style={{ fontSize: 20, fontWeight: 300, color: C.textDim, verticalAlign: 4 }}>.{formatted.cents}</span>
        </div>
        ...
        {costRows.map((row, i) => (
          ...
          >
            ...
            <div
              ...
              onMouseLeave={e => {
                const bar = e.currentTarget.querySelector("div");
                if (bar) bar.style.filter = "brightness(1)";
              }}
            >
              <div
                style={{
