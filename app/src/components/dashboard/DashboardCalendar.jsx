        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4, flexShrink: 0 }}>
          <button
            ...
            style={{
              ...
              cursor: "pointer",
              fontSize: 11,
              color: ev.completed ? C.green : C.textDim,
              padding: "0 2px",
              lineHeight: 1,
            }}
    ...
    <div style={{ ...glass, marginTop: 16, maxWidth: 480, width: "100%", marginBottom: 20 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10, gap: 6 }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                letterSpacing: "0.04em",
                background:
                  calendarView === v.key ? (dk ? "rgba(255,255,255,0.10)" : "rgba(255,255,255,0.40)") : "transparent",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 4, flex: 1, justifyContent: "center", minWidth: 0 }}>
          ...
          <div
            style={{
              fontSize: calendarView === "day" ? 9 : 11,
              fontWeight: 600,
              letterSpacing: "0.04em",
              color: C.text,
              fontFamily: T.font.display,
            ...
            {calendarDays.map((cell, i) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={e => {
                    if (!isSelected) e.currentTarget.style.background = ov(0.06);
                  }}
                  onMouseLeave={e => {
      ...
      {/* ─── Add Task Modal ──────────────────────────────── */}
      {showAddModal && <AddTaskModal defaultDate={selectedDate} onClose={() => setShowAddModal(false)} />}
    </div>
  );
}
