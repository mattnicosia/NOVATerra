...
const NAV_ICONS = {
  ...
  database: (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
      <ellipse cx="8" cy="4" rx="6" ry="2"/><path d="M2 4v4c0 1.1 2.7 2 6 2s6-.9 6-2V4"/>
  ...
  people: (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
      ...
      <circle cx="12" cy="5" r="2"/><path d="M12 8.5c1.7.2 3 1.5 3 3.5"/>
    </svg>
  ),
  settings: (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
  ...
  projects: (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
      <rect x="1.5" y="3" width="13" height="10" rx="1.5"/><path d="M5.5 3V2a1 1 0 011-1h3a1 1 0 011 1v1"/><path d="M1.5 7h13"/>
    </svg>
  ),
  intelligence: (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 12l3-4 3 2 3-5 3 4"/><path d="M2 14h12"/><path d="M14 2v10"/>
    </svg>
  ),
};
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 4, position: 'relative' }}>
        ...
        {novaStatus === 'thinking' && novaActivity && (
          <div style={{
            ...
            <span style={{ fontSize: 10, color: accent, fontWeight: 500, maxWidth: 160, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', fontFamily: "'DM Sans', sans-serif" }}>
              {novaActivity}
            </span>
            {novaTask?.progress > 0 && (
        ...
        {/* Notifications */}
        <button data-interactive onClick={() => setNotificationsOpen(v => !v)} style={{
          ...
          {[
            ...
            <button key={t.key} data-interactive title={t.title}
              ...
              style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                background: activeTheme === t.key ? ov(0.10, 0.08) : 'transparent',
                color: activeTheme === t.key ? tglActive : tglInactive,
                transition: 'all 0.15s',
              }}
              onMouseEnter={e => { if (activeTheme !== t.key) { e.currentTarget.style.color = tglHover; e.currentTarget.style.background = ov(0.05, 0.04); } }}
              onMouseLeave={e => { if (activeTheme !== t.key) { e.currentTarget.style.color = tglInactive; e.currentTarget.style.background = 'transparent'; } }}
            >{t.icon}</button>
          ))}
        </div>
        ...
        {/* Avatar + Dropdown */}
        <div style={{ position: 'relative' }}>
          <div data-interactive onClick={() => setProfileMenuOpen(v => !v)} style={{
