    ...
    <div style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {novaBrief.text ? (
          ...
          <div style={{ fontSize: 11, color: C.textDim }}>
            Click refresh to generate a market intelligence brief.
          </div>
        )}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 8 }}>
          <button
            ...
            style={{
              background: "none", border: `1px solid ${C.accent}30`, borderRadius: 4,
              color: C.accent, fontSize: 9, fontWeight: 600, cursor: "pointer",
              padding: "3px 8px", opacity: novaBrief.loading ? 0.5 : 1,
            }}
          >
