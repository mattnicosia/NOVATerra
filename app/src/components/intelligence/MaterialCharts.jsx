...
function ChartCard({ seriesKey, data, series }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
        <div>
          ...
          <div style={{ display: "flex", alignItems: "baseline", gap: 6, marginTop: 4 }}>
            <span style={{ fontSize: 18, fontWeight: 800, color: C.text, fontFamily: T.font.sans }}>
      ...
      {/* Chart */}
      <BarChart data={chartData} height={70} showLabels={false} barColor={color} animate={true} />
...
export default function MaterialCharts() {
  ...
  const hasFredData = Object.entries(FRED_SERIES).some(([key]) => fredData[key] && fredData[key].length > 0);
  ...
  if (!fredApiKey) {
    return (
      ...
      >
        ...
        <div style={{ fontSize: 14, fontWeight: 700, color: C.text, marginTop: 10 }}>Connect to Market Data</div>
