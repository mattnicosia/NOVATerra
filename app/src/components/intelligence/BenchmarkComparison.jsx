...
const ROM_DIVISIONS = [
  { code: "01", label: "General Req" }, { code: "03", label: "Concrete" },
  { code: "05", label: "Metals" }, { code: "07", label: "Thermal" },
  { code: "08", label: "Openings" }, { code: "09", label: "Finishes" },
  { code: "22", label: "Plumbing" }, { code: "23", label: "HVAC" },
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 9, fontWeight: 700, color: C.textDim, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 12 }}>
          Total $/SF Comparison
        </div>
        ...
        <div>
          ...
          <RangeBar
            low={industry.low * 0.95} mid={industry.mid} high={industry.high * 0.95}
            marker={industry.mid}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          {BUILDING_TYPES.map(bt => {
            ...
            return (
              ...
              >
                <span style={{
                  fontSize: 9, width: 120, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                  color: isSelected ? C.accent : C.textDim, fontWeight: isSelected ? 700 : 400,
                }}>
                  {bt.label}
                </span>
