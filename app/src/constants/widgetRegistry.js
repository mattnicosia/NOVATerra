...
export const WIDGET_REGISTRY = {
  ...
  spotify: {
    ...
    category: "thirdparty",
    singleton: false,
    configFields: [{ key: "url", label: "Spotify URL", type: "text", placeholder: "https://open.spotify.com/..." }],
  },
  iframe: {
    label: "Custom Embed",
  ...
  "quick-actions": {
    label: "Quick Actions",
    description: "One-click: new estimate, upload plans, import CSV, settings",
    defaultW: 3,
    defaultH: 5,
    minW: 3,
    minH: 4,
  ...
  "nova-insights": {
    label: "NOVA Insights",
    description: "AI observations from scans, corrections, and firm learning",
    defaultW: 3,
    defaultH: 5,
    minW: 3,
    minH: 4,
