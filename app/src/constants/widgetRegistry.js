...
export const WIDGET_REGISTRY = {
  ...
  "team-activity": {
    label: "Team Activity",
    description: "Real-time team activity feed — who's doing what",
    defaultW: 3,
    defaultH: 6,
    minW: 2,
    minH: 4,
  ...
  "win-rate": {
    label: "Win Rate",
    description: "Bid hit rate donut with won/lost/active breakdown",
    defaultW: 3,
    defaultH: 5,
    minW: 2,
    minH: 4,
  ...
  "nova-insights": {
    label: "NOVA Insights",
    description: "AI learning progress — corrections, patterns, accuracy",
    defaultW: 3,
    defaultH: 6,
    minW: 2,
    minH: 4,
