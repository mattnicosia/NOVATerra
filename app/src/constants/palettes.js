...
export const PALETTES = [
  ...
  {
    id: "nova", name: "NOVA", desc: "Galaxy nebula — purple, blue & white core",
    preview: ["#08091A", "#8B5CF6", "#60A5FA", "#C084FC", "#F5F3FF"],
    variantLabels: ["Nebula", "Cosmos", "Aurora", "NOVA Light", "Stardust"],
    overrides: {
      bg: "#06060C", bg1: "#0C0B14", bg2: "#12101C", bg3: "#1A1828",
      border: "rgba(255,255,255,0.07)", borderLight: "rgba(255,255,255,0.04)", borderAccent: "rgba(139,92,246,0.18)",
      text: "#EEEDF5", textMuted: "rgba(238,237,245,0.55)", textDim: "rgba(238,237,245,0.28)",
      accent: "#8B5CF6", accentDim: "#6D28D9", accentBg: "rgba(139,92,246,0.07)", accentAlt: "#A78BFA",
      gradient: "linear-gradient(135deg, #8B5CF6, #A78BFA)", gradientSubtle: `linear-gradient(135deg, ${hR("#8B5CF6", 0.12)}, ${hR("#A78BFA", 0.12)})`, gradientText: "linear-gradient(135deg, #8B5CF6, #A78BFA)",
      green: "#34D399", red: "#FB7185", blue: "#60A5FA", purple: "#C4B5FD", orange: "#F59E0B", cyan: "#64D2FF",
      sidebarBg: "rgba(6,6,12,0.96)", glassBg: "rgba(18,16,28,0.75)", glassBorder: "rgba(255,255,255,0.06)",
      glassBgDark: "rgba(8,8,16,0.75)",
      bgGradient: "#06060C",
      forceDark: true,
    },
    variants: [
      ...
      { // 1 — Cosmos — deeper, blue-shifted
        bg: "#04051A", bg1: "#0A0C28", bg2: "#0E1238", bg3: "#141A48",
        accent: "#60A5FA", accentDim: dk("#60A5FA"), accentBg: hR("#60A5FA", 0.08), accentAlt: "#8B5CF6",
        borderAccent: hR("#60A5FA", 0.18),
        gradient: "linear-gradient(135deg, #60A5FA, #8B5CF6)", gradientSubtle: `linear-gradient(135deg, ${hR("#60A5FA", 0.12)}, ${hR("#8B5CF6", 0.12)})`, gradientText: "linear-gradient(135deg, #60A5FA, #8B5CF6)",
        sidebarBg: "rgba(4,5,26,0.92)",
      },
      { // 2 — Aurora — cyan + purple
        bg: "#06091C", bg1: "#0C1028", bg2: "#121838", bg3: "#1A2248",
        accent: "#C084FC", accentDim: dk("#C084FC"), accentBg: hR("#C084FC", 0.08), accentAlt: "#64D2FF",
  ...
  {
    id: "clarity", name: "Clarity", desc: "Clean light — Apple-grade minimal",
    ...
    overrides: {
      ...
      text: "#F5F5F7", textMuted: "rgba(245,245,247,0.55)", textDim: "rgba(245,245,247,0.30)",
      accent: "#007AFF", accentDim: "#0055D4", accentBg: hR("#007AFF", 0.08), accentAlt: "#5AC8FA",
      gradient: "linear-gradient(135deg, #007AFF, #5AC8FA)",
      gradientSubtle: `linear-gradient(135deg, ${hR("#007AFF", 0.10)}, ${hR("#5AC8FA", 0.10)})`,
      gradientText: "linear-gradient(135deg, #007AFF, #5AC8FA)",
      green: "#30D158", red: "#FF453A", blue: "#0A84FF", purple: "#BF5AF2",
      orange: "#FF9F0A", cyan: "#5AC8FA", yellow: "#FFD60A",
      sidebarBg: "rgba(28,28,30,0.96)",
      glassBg: "rgba(44,44,46,0.72)", glassBorder: "rgba(255,255,255,0.06)",
  ...
  {
    id: "matte", name: "Matte", desc: "True black — refined matte finish",
    preview: ["#000000", "#0A84FF", "#141414", "#F5F5F7", "#1C1C1C"],
    variantLabels: ["Black", "Void", "Ember", "Frost"],
    overrides: {
      bg: "#000000", bg1: "#0A0A0A", bg2: "#141414", bg3: "#1C1C1C",
      border: "rgba(255,255,255,0.06)", borderLight: "rgba(255,255,255,0.03)",
      borderAccent: hR("#0A84FF", 0.12),
      text: "#F5F5F7", textMuted: "rgba(245,245,247,0.50)", textDim: "rgba(245,245,247,0.25)",
      accent: "#0A84FF", accentDim: "#0066CC", accentBg: hR("#0A84FF", 0.06), accentAlt: "#64D2FF",
      gradient: "linear-gradient(135deg, #0A84FF, #64D2FF)",
      gradientSubtle: `linear-gradient(135deg, ${hR("#0A84FF", 0.08)}, ${hR("#64D2FF", 0.08)})`,
      gradientText: "linear-gradient(135deg, #0A84FF, #64D2FF)",
      green: "#30D158", red: "#FF453A", blue: "#0A84FF", purple: "#BF5AF2",
      orange: "#FF9F0A", cyan: "#64D2FF", yellow: "#FFD60A",
      sidebarBg: "rgba(0,0,0,0.96)",
      glassBg: "rgba(10,10,10,0.65)", glassBorder: "rgba(255,255,255,0.04)",
    ...
    variants: [
      ...
      { // 1 — Void: ultra-minimal gray accent
        accent: "#86868B", accentDim: "#636366", accentBg: hR("#86868B", 0.06), accentAlt: "#AEAEB2",
        borderAccent: hR("#86868B", 0.10),
      ...
      { // 2 — Ember: warm amber accent
        bg: "#050403", bg1: "#0E0D0A", bg2: "#181610", bg3: "#211F18",
        accent: "#FF9F0A", accentDim: "#CC7F08", accentBg: hR("#FF9F0A", 0.06), accentAlt: "#FFD60A",
        borderAccent: hR("#FF9F0A", 0.10),
      ...
      { // 3 — Frost: ice-white accent
        accent: "#E5E5EA", accentDim: "#C7C7CC", accentBg: hR("#E5E5EA", 0.06), accentAlt: "#8E8E93",
