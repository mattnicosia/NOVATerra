...
// Also includes learning state: corrections, global patterns, firm memory,
// evaluation logging, and vector sync (was novaLearningStore).
...
export const useNovaStore = create((set, get) => ({
  ...
  // ═══ Corrections (was novaLearningStore) ═══════════════════════
  corrections: [],
  globalPatterns: [],
  ...
  logCorrection: (type, details) => {
    ...
    clearTimeout(useNovaStore._syncTimer);
    useNovaStore._syncTimer = setTimeout(async () => {
      try {
  ...
  // ═══ Firm Memory (was novaLearningStore) ═══════════════════════
  firms: {},
...
// ═══════════════════════════════════════════════════════════════
// Evaluation Logger (was novaLearningStore — standalone functions)
// ═══════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════
// Correction Sync (was novaLearningStore — standalone functions)
// ═══════════════════════════════════════════════════════════════
...
export async function syncCorrectionsToVector() {
  const { corrections, setCorrections } = useNovaStore.getState();
