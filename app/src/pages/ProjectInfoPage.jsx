  ...
  const handleSave = async () => {
    ...
    if (isDraft) {
      ...
      updateIndexEntry(activeEstimateId, {
        ...
        bidDueTime: project.bidDueTime || "",
        startDate: project.startDate || "",
        date: project.date || "",
        estimatedHours: project.estimatedHours || "",
        estimator: project.estimator || "",
        coEstimators: project.coEstimators || [],
        jobType: project.jobType || "",
        buildingType: project.buildingType || "",
        workType: project.workType || "",
        bidType: project.bidType || "",
        bidDelivery: project.bidDelivery || "",
        ...
        walkthroughDate: project.walkthroughDate || "",
        rfiDueDate: project.rfiDueDate || "",
        bidRequirements: project.bidRequirements || {},
