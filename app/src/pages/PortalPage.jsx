...
export default function PortalPage() {
      ...
      <div style={pageStyle}>
        <div style={containerStyle}>
          ...
          <div style={{ textAlign: 'center', padding: '60px 0' }}>
            ...
            <h3 style={{ color: C.text, fontSize: 18, fontWeight: 600, margin: '0 0 8px' }}>
              Invalid Invitation
            </h3>
  ...
  const dueStr = pkg?.dueDate
    ? new Date(pkg.dueDate + 'T12:00:00').toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric', year: 'numeric' })
    : null;
  ...
  return (
    <div style={pageStyle}>
      <div style={containerStyle}>
        ...
        {/* Project Info Card */}
        <div style={cardStyle}>
          <div style={{ fontSize: 11, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 1, color: C.accent, marginBottom: 8 }}>
          ...
          {dueStr && (
            <div style={{
              ...
              <svg width={16} height={16} viewBox="0 0 24 24" fill="none" stroke={isPastDue ? C.red : C.accent} strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
                <circle cx="12" cy="12" r="10" /><path d="M12 6v6l4 2" />
              </svg>
              <span style={{ color: isPastDue ? C.red : C.text, fontSize: 14, fontWeight: 500 }}>
                {isPastDue ? 'Past Due: ' : 'Due: '}{dueStr}
              </span>
            </div>
          )}
        ...
        <div style={cardStyle}>
          {submitted ? (
            <div style={{ textAlign: 'center', padding: '40px 0' }}>
              ...
              <p style={{ color: C.textMuted, fontSize: 14, lineHeight: 1.5 }}>
                Your proposal has been received and is being processed.<br />
                ...
                {uploading ? (
                  <>
                    <div style={{
                      ...
                      background: C.border, margin: '0 auto 12px', overflow: 'hidden',
                    }}>
                      <div style={{
                  ...
                  <>
                    <svg width={40} height={40} viewBox="0 0 24 24" fill="none" stroke={C.accent} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: 12 }}>
