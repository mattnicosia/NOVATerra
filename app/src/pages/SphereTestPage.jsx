...
function Slider({ label, value, onChange, min = 0, max = 1, step = 0.01 }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 6 }}>
      ...
      />
      <span style={{ width: 46, fontSize: 11, fontWeight: 700, color: "#fff", fontFamily: "monospace", textAlign: "right" }}>
        {value.toFixed(2)}
      </span>
    </div>
  );
  ...
  return (
    <button
      ...
      style={{
        ...
        fontFamily: T_FONT, letterSpacing: "0.05em",
      }}
    >
      {label}
    </button>
    ...
    <div style={{
      ...
      <div style={{ position: "relative", marginBottom: 32 }}>
        ...
        <div style={{
          ...
          {morph < 0.15 ? "NOVA — Idle" :
           morph < 0.35 ? "NOVA — Thinking" :
           morph < 0.6 ? "Transitioning" :
           morph < 0.85 ? "CORE — Active" :
           "CORE — Fusion"}
        </div>
      </div>
      ...
      <div style={{ width: 440, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 10, fontWeight: 700, color: "#555", letterSpacing: "0.08em", marginBottom: 10, textTransform: "uppercase" }}>
            Actions
          </div>
            ...
            <ActionButton
              onClick={() => {
                ...
                const interval = setInterval(() => {
                  v += 0.015;
                  if (v > 2) { clearInterval(interval); setMorph(0); return; }
                  setMorph(v <= 1 ? v : 2 - v);
                }, 25);
              }}
              label="MORPH CYCLE"
