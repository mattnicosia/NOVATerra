...
function GuidedWizardPath({ onResult, onBack }) {
  ...
  // ── Wizard step logic (extracted) ──
  const {
    step, setStep, answers, inputValue, setInputValue, yesNoState,
    handleSelect, handleInputSubmit, initYesNo, toggleYesNo, handleYesNoContinue,
  } = useGuidedWizard({ questions: WIZARD_QUESTIONS, onResult });
