    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          ...
          <p style={{ fontSize: 12, color: C.textMuted, margin: "4px 0 0" }}>{data?.total ?? "—"} registered users</p>
        </div>
      </div>
      ...
      {!loading && !error && (
        <div style={{ ...card(C), overflow: "hidden" }}>
          ...
          {/* Rows */}
          {users.length === 0 ? (
            <div style={{ padding: 24, textAlign: "center", color: C.textMuted, fontSize: 12 }}>No users found</div>
          ) : (
            users.map(u => (
              <div
                key={u.id}
              ...
              >
                ...
                <span style={{ color: C.textDim, fontFamily: T.font.sans, fontSize: 11 }}>
                ...
                <span
                  style={{ textAlign: "right", color: C.text, fontWeight: 600, fontFamily: T.font.sans }}
                >
                  {u.estimateCount}
                </span>
                <span
