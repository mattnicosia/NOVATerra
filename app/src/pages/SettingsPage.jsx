      ...
      <div style={{ maxWidth: 1000 }}>
        ...
        <Sec title="AI Configuration">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
            <div style={{ padding: "10px 14px", background: `${C.green}08`, borderRadius: 6, border: `1px solid ${C.green}25`, display: "flex", alignItems: "center", gap: 10 }}>
              <Ic d={I.check} size={16} color={C.green} />
              <div>
                <div style={{ fontSize: 11, fontWeight: 600, color: C.text }}>AI is built-in</div>
                <div style={{ fontSize: 10, color: C.textDim, marginTop: 2 }}>NOVA AI features are included with your account. No API key needed.</div>
              </div>
            </div>
            <div>
        ...
        <Sec title="Cost History & ROM Calibration">
          <div style={{ fontSize: 11, color: C.textMuted, lineHeight: 1.6 }}>
            Historical proposals and ROM calibration data has moved to the <strong style={{ color: C.accent }}>Cost Database → Cost History</strong> tab.
          </div>
        </Sec>
      ...
      {editingProfile && (
        <div style={{ padding: 16, background: C.bg1, borderRadius: T.radius.md, border: `1px solid ${C.border}` }}>
          ...
          <div style={{ marginTop: 18, borderTop: `1px solid ${C.border}`, paddingTop: 14 }}>
            <div style={{ fontSize: 10, fontWeight: 700, color: C.accent, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 4, display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <div style={{ fontSize: 10, color: C.textDim, marginBottom: 12, lineHeight: 1.5 }}>
              These appear automatically on every new estimate using this profile. Estimators can remove individual items per-project.
            </div>
            ...
            <div style={{ marginBottom: 14 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <button
                  ...
                  style={{
                    background: `${C.accent}10`, border: `1px solid ${C.accent}30`, borderRadius: 4,
                    padding: "2px 8px", fontSize: 9, fontWeight: 600, color: C.accent, cursor: "pointer",
              ...
              {(editingProfile?.boilerplateExclusions || []).length === 0 && (
                <div style={{ fontSize: 10, color: C.textDim, fontStyle: "italic", padding: "6px 0" }}>No default exclusions yet</div>
              )}
              {(editingProfile?.boilerplateExclusions || []).map((ex, i) => (
                <div key={ex.id} style={{ display: "flex", alignItems: "start", gap: 6, marginBottom: 4 }}>
                  <span style={{ fontSize: 9, color: C.textDim, fontWeight: 600, paddingTop: 7, minWidth: 16 }}>{i + 1}.</span>
                  <textarea
                    value={ex.text}
                    onChange={e => {
                    ...
                    style={{
                      ...
                      flex: 1, fontFamily: "'DM Sans',sans-serif", lineHeight: 1.5,
                    }}
                  />
                  <button
                    onClick={() => {
                    ...
                    style={{ background: "none", border: "none", cursor: "pointer", padding: 4, marginTop: 3, opacity: 0.5 }}
                    title="Remove">
            ...
            <div>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 6 }}>
                ...
                <button
                  onClick={() => {
                    const list = [...(editingProfile?.boilerplateNotes || []), { id: uid(), text: "", category: "clarification" }];
              ...
              {(editingProfile?.boilerplateNotes || []).length === 0 && (
                <div style={{ fontSize: 10, color: C.textDim, fontStyle: "italic", padding: "6px 0" }}>No default notes yet</div>
              )}
