    ...
    <div style={{
      ...
      <div style={{ maxWidth: 700, margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div>
            <img src="/novaterra-wordmark.png" alt="NOVATerra" style={{ height: 18, objectFit: 'contain', display: 'block' }} />
        ...
        {error && (
          <div style={{
            ...
            color: '#FF453A', fontSize: 13, marginBottom: 20,
          }}>
            {error}
          </div>
        )}
        ...
        {!dashData && !loading && !sent && (
          <div style={{
            ...
            <h1 style={{ color: C.text, fontSize: 22, fontWeight: 600, margin: '0 0 8px' }}>
        ...
        {sent && !dashData && (
          <div style={{
            ...
            <h2 style={{ color: '#30D158', fontSize: 18, fontWeight: 600, margin: '0 0 8px' }}>
              Check your email
            </h2>
            <p style={{ color: C.textMuted, fontSize: 14, margin: 0, lineHeight: 1.5 }}>
              If <strong style={{ color: C.text }}>{email}</strong> has bid invitations in our system, you'll receive a secure link to your dashboard.
            </p>
          </div>
        )}
        ...
        {dashData && (
          <>
            ...
            {/* Invitations list */}
            <div style={{ color: C.textMuted, fontSize: 12, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 10 }}>
                  ...
                  <div key={inv.id} style={{
                    ...
                    {inv.feedbackNotes && inv.status === 'not_awarded' && (
                      <div style={{
                        ...
                        <div style={{ color: C.accent, fontSize: 10, fontWeight: 600, textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 4 }}>
                          Feedback
                        </div>
...
function StatBox({ label, value, color }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 10, fontWeight: 600, color: '#8E8E93', textTransform: 'uppercase', letterSpacing: 0.3, marginTop: 6 }}>{label}</div>
    </div>
  );
}
