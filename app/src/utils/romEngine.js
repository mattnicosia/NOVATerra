...
const BENCHMARKS = {
  // Commercial office — recalibrated 2024-2026 NY metro (Spark Newburgh $673, Brewster $227, Wolkoff $95)
  // Range: $180/SF (fit-out) → $320/SF (full reno) → $550+/SF (new construction/complex)
  "commercial-office": {
    "01": { label: "General Requirements", low: 12, mid: 22, high: 38 },
    "02": { label: "Existing Conditions/Demo", low: 3, mid: 10, high: 22 },
    "03": { label: "Concrete", low: 12, mid: 25, high: 45 },
    "04": { label: "Masonry", low: 3, mid: 10, high: 20 },
    "05": { label: "Structural Steel", low: 10, mid: 22, high: 40 },
    "06": { label: "Wood, Plastics & Composites", low: 5, mid: 12, high: 25 },
    "07": { label: "Thermal & Moisture", low: 6, mid: 14, high: 25 },
    "08": { label: "Openings", low: 8, mid: 18, high: 35 },
    "09": { label: "Finishes", low: 20, mid: 40, high: 65 },
    10: { label: "Specialties", low: 3, mid: 8, high: 15 },
    14: { label: "Conveying", low: 0, mid: 8, high: 20 },
    21: { label: "Fire Suppression", low: 4, mid: 8, high: 14 },
    22: { label: "Plumbing", low: 8, mid: 18, high: 32 },
    23: { label: "HVAC", low: 15, mid: 30, high: 50 },
    26: { label: "Electrical", low: 12, mid: 25, high: 42 },
    27: { label: "Communications", low: 3, mid: 8, high: 15 },
    28: { label: "Electronic Safety", low: 2, mid: 6, high: 12 },
    31: { label: "Earthwork", low: 4, mid: 10, high: 20 },
    32: { label: "Exterior Improvements", low: 3, mid: 8, high: 16 },
    33: { label: "Utilities", low: 3, mid: 7, high: 14 },
  },
  // Retail benchmarks — recalibrated from Violante proposals (Laundry Heaven, 792 Atlantic, etc.)
  retail: {
    "01": { label: "General Requirements", low: 6, mid: 12, high: 20 },
    "02": { label: "Existing Conditions/Demo", low: 2, mid: 6, high: 14 },
    "03": { label: "Concrete", low: 2, mid: 5, high: 12 },
    "05": { label: "Structural Steel", low: 0, mid: 4, high: 10 },
    "06": { label: "Wood, Plastics & Composites", low: 5, mid: 12, high: 30 },
    "07": { label: "Thermal & Moisture", low: 4, mid: 10, high: 20 },
    "08": { label: "Openings", low: 5, mid: 10, high: 20 },
    "09": { label: "Finishes (D&C, ACT, Paint, Flooring)", low: 20, mid: 38, high: 65 },
    10: { label: "Specialties", low: 2, mid: 6, high: 12 },
    12: { label: "Furnishings", low: 3, mid: 8, high: 18 },
    21: { label: "Fire Suppression", low: 3, mid: 6, high: 10 },
    22: { label: "Plumbing", low: 4, mid: 10, high: 20 },
    23: { label: "HVAC", low: 8, mid: 15, high: 28 },
    26: { label: "Electrical", low: 8, mid: 15, high: 25 },
    28: { label: "Electronic Safety", low: 1, mid: 3, high: 6 },
  },
  // Healthcare — recalibrated (Venus & Venum $549, Ability Beyond $605, Integrative Dental $126)
  // Range: $200/SF (clinic reno) → $350/SF (medical office) → $550+/SF (new construction)
  healthcare: {
    "01": { label: "General Requirements", low: 12, mid: 22, high: 35 },
    "02": { label: "Existing Conditions/Demo", low: 3, mid: 8, high: 18 },
    "03": { label: "Concrete", low: 14, mid: 25, high: 42 },
    "05": { label: "Structural Steel", low: 10, mid: 20, high: 35 },
    "06": { label: "Wood & Plastics", low: 4, mid: 10, high: 20 },
    "07": { label: "Thermal & Moisture", low: 6, mid: 14, high: 24 },
    "08": { label: "Openings", low: 10, mid: 20, high: 32 },
    "09": { label: "Finishes", low: 22, mid: 38, high: 58 },
    10: { label: "Specialties (Medical)", low: 5, mid: 12, high: 22 },
    21: { label: "Fire Suppression", low: 5, mid: 10, high: 16 },
    22: { label: "Plumbing (Medical Gas)", low: 14, mid: 25, high: 42 },
    23: { label: "HVAC (Clean Air)", low: 20, mid: 38, high: 60 },
    26: { label: "Electrical", low: 15, mid: 28, high: 45 },
    27: { label: "Communications", low: 3, mid: 8, high: 15 },
    28: { label: "Electronic Safety", low: 4, mid: 10, high: 18 },
  },
  education: {
  ...
  // Industrial — recalibrated (RRIS 1 Orchard $216, Bearsville Metal Shop $353)
  // Range: $150/SF (basic warehouse) → $220/SF (fab shop) → $350+/SF (specialized)
  industrial: {
    "01": { label: "General Requirements", low: 8, mid: 15, high: 25 },
    "02": { label: "Existing Conditions", low: 2, mid: 5, high: 12 },
    "03": { label: "Concrete (SOG/Foundation)", low: 18, mid: 30, high: 48 },
    "05": { label: "Structural Steel", low: 22, mid: 38, high: 58 },
    "07": { label: "Thermal & Moisture / Roofing", low: 8, mid: 16, high: 28 },
    "08": { label: "Openings (OH Doors)", low: 6, mid: 12, high: 22 },
    "09": { label: "Finishes", low: 5, mid: 12, high: 22 },
    22: { label: "Plumbing", low: 5, mid: 10, high: 18 },
    23: { label: "HVAC", low: 10, mid: 20, high: 35 },
    26: { label: "Electrical (3-Phase)", low: 12, mid: 22, high: 38 },
    31: { label: "Earthwork", low: 8, mid: 18, high: 30 },
    32: { label: "Exterior / Paving", low: 5, mid: 12, high: 22 },
  },
  // Residential multi-family — recalibrated (1-3 S Broadway Nyack $290/SF)
  // Range: $180/SF (garden-style) → $280/SF (mid-rise reno) → $420+/SF (new construction)
  "residential-multi": {
    "01": { label: "General Requirements", low: 10, mid: 18, high: 30 },
    "02": { label: "Existing Conditions/Demo", low: 3, mid: 8, high: 18 },
    "03": { label: "Concrete", low: 12, mid: 22, high: 38 },
    "05": { label: "Structural Steel", low: 6, mid: 14, high: 25 },
    "06": { label: "Wood Framing", low: 15, mid: 28, high: 45 },
    "07": { label: "Thermal & Moisture", low: 8, mid: 15, high: 25 },
    "08": { label: "Openings", low: 10, mid: 18, high: 30 },
    "09": { label: "Finishes (per unit)", low: 18, mid: 32, high: 50 },
    10: { label: "Specialties", low: 3, mid: 6, high: 12 },
    14: { label: "Conveying", low: 0, mid: 5, high: 15 },
    21: { label: "Fire Suppression", low: 4, mid: 8, high: 14 },
    22: { label: "Plumbing (per unit)", low: 12, mid: 22, high: 35 },
    23: { label: "HVAC", low: 12, mid: 22, high: 35 },
    26: { label: "Electrical", low: 10, mid: 20, high: 32 },
    31: { label: "Earthwork", low: 3, mid: 8, high: 16 },
  },
  hospitality: {
  ...
  // Residential single-family — recalibrated from Montana GC proposals (2024-2026)
  // Range: $250/SF (production) → $400/SF (custom) → $550+/SF (luxury/modern)
  "residential-single": {
    "01": { label: "General Requirements", low: 15, mid: 25, high: 40 },
    "02": { label: "Existing Conditions/Demo", low: 2, mid: 5, high: 12 },
    "03": { label: "Concrete (Foundation/Slab)", low: 18, mid: 30, high: 45 },
    "04": { label: "Masonry", low: 2, mid: 8, high: 18 },
    "05": { label: "Structural Steel", low: 3, mid: 8, high: 18 },
    "06": { label: "Wood Framing & Finish Carpentry", low: 40, mid: 65, high: 95 },
    "07": { label: "Thermal & Moisture / Roofing", low: 15, mid: 25, high: 40 },
    "08": { label: "Windows & Doors", low: 18, mid: 30, high: 55 },
    "09": { label: "Finishes (Drywall, Paint, Tile, Flooring)", low: 30, mid: 50, high: 85 },
    10: { label: "Specialties (Cabinets, Countertops)", low: 12, mid: 22, high: 40 },
    22: { label: "Plumbing", low: 15, mid: 25, high: 40 },
    23: { label: "HVAC", low: 14, mid: 22, high: 35 },
    26: { label: "Electrical", low: 14, mid: 22, high: 35 },
    31: { label: "Earthwork / Site", low: 8, mid: 15, high: 28 },
    32: { label: "Exterior Improvements", low: 5, mid: 12, high: 22 },
  },
  "mixed-use": {
  ...
  restaurant: {
    ...
    "02": { label: "Existing Conditions/Demo", low: 3, mid: 8, high: 18 },
    "03": { label: "Concrete", low: 2, mid: 5, high: 12 },
    "05": { label: "Structural Steel", low: 0, mid: 3, high: 8 },
    "06": { label: "Wood, Plastics & Composites", low: 5, mid: 15, high: 35 },
    "07": { label: "Thermal & Moisture", low: 2, mid: 5, high: 12 },
    "08": { label: "Openings", low: 4, mid: 8, high: 15 },
    "09": { label: "Finishes (D&C, ACT, Paint, Tile, Flooring)", low: 25, mid: 45, high: 80 },
    10: { label: "Specialties (FRP, Bath Acc, Signage)", low: 3, mid: 8, high: 18 },
    11: { label: "Equipment (Kitchen, Food Service)", low: 20, mid: 40, high: 70 },
    12: { label: "Furnishings (Countertops, Casework)", low: 5, mid: 12, high: 25 },
    21: { label: "Fire Suppression", low: 4, mid: 8, high: 14 },
    22: { label: "Plumbing", low: 12, mid: 24, high: 45 },
    23: { label: "HVAC", low: 10, mid: 18, high: 32 },
    26: { label: "Electrical", low: 10, mid: 18, high: 30 },
    28: { label: "Electronic Safety", low: 2, mid: 4, high: 8 },
  },
  parking: {
