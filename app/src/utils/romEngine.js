...
const BENCHMARK_SAMPLE_COUNTS = {
  ...
  "residential-single":{ _default: 20, "06": 20, "09": 20, "03": 20 },
...
const BENCHMARKS = {
  // Commercial office — FROM ACTUAL PROPOSALS (2 GC projects, $560/SF mid)
  // Spark Newburgh $673/SF, Brewster Breakroom $227/SF
  "commercial-office": {
    "01": { label: "General Requirements", low: 41, mid: 41, high: 41 },
    "02": { label: "Existing Conditions/Demo", low: 2, mid: 4, high: 6 },
    "03": { label: "Concrete", low: 43, mid: 43, high: 43 },
    ...
    "08": { label: "Openings", low: 21, mid: 21, high: 21 },
    "09": { label: "Finishes", low: 37, mid: 45, high: 53 },
    10: { label: "Specialties", low: 4, mid: 4, high: 4 },
    12: { label: "Furnishings", low: 3, mid: 3, high: 3 },
    21: { label: "Fire Suppression", low: 7, mid: 7, high: 7 },
    22: { label: "Plumbing", low: 33, mid: 49, high: 65 },
    23: { label: "HVAC", low: 27, mid: 27, high: 27 },
    26: { label: "Electrical", low: 29, mid: 45, high: 62 },
    28: { label: "Electronic Safety", low: 3, mid: 3, high: 3 },
    31: { label: "Earthwork", low: 58, mid: 58, high: 58 },
    32: { label: "Exterior Improvements", low: 79, mid: 79, high: 79 },
  },
  // Retail — FROM ACTUAL PROPOSALS (2 GC projects, $202/SF mid)
  retail: {
    "01": { label: "General Requirements", low: 22, mid: 26, high: 31 },
    "03": { label: "Concrete", low: 5, mid: 5, high: 5 },
    "06": { label: "Wood, Plastics & Composites", low: 4, mid: 5, high: 5 },
    "07": { label: "Thermal & Moisture", low: 2, mid: 3, high: 4 },
    "09": { label: "Finishes (D&C, ACT, Paint, Flooring)", low: 34, mid: 38, high: 42 },
    21: { label: "Fire Suppression", low: 3, mid: 3, high: 4 },
    22: { label: "Plumbing", low: 11, mid: 13, high: 15 },
    23: { label: "HVAC", low: 43, mid: 44, high: 46 },
    26: { label: "Electrical", low: 49, mid: 51, high: 53 },
    27: { label: "Communications", low: 3, mid: 5, high: 6 },
    28: { label: "Electronic Safety", low: 6, mid: 7, high: 7 },
  },
  // Healthcare — FROM ACTUAL PROPOSALS (2 projects, $362/SF mid)
  // Venus & Venum $549/SF, Ability Beyond $605/SF, Integrative Dental $126/SF
  healthcare: {
    "01": { label: "General Requirements", low: 7, mid: 21, high: 36 },
    "02": { label: "Existing Conditions/Demo", low: 8, mid: 13, high: 17 },
    "03": { label: "Concrete", low: 7, mid: 7, high: 7 },
    "04": { label: "Masonry", low: 6, mid: 6, high: 6 },
    "05": { label: "Structural Steel", low: 3, mid: 3, high: 3 },
    "06": { label: "Wood & Plastics", low: 48, mid: 55, high: 62 },
    "07": { label: "Thermal & Moisture", low: 50, mid: 50, high: 50 },
    "08": { label: "Openings", low: 1, mid: 18, high: 35 },
    "09": { label: "Finishes", low: 25, mid: 41, high: 58 },
    10: { label: "Specialties", low: 1, mid: 1, high: 1 },
    11: { label: "Equipment", low: 3, mid: 3, high: 3 },
    22: { label: "Plumbing (Medical Gas)", low: 12, mid: 18, high: 24 },
    23: { label: "HVAC (Clean Air)", low: 71, mid: 71, high: 71 },
    26: { label: "Electrical", low: 42, mid: 42, high: 42 },
    28: { label: "Electronic Safety", low: 7, mid: 7, high: 7 },
  },
  education: {
  ...
  // Industrial — FROM ACTUAL PROPOSALS (3 projects, $310/SF mid)
  // RRIS 1 Orchard $216, Bearsville Metal Shop $353
  industrial: {
    "01": { label: "General Requirements", low: 1, mid: 15, high: 37 },
    "02": { label: "Existing Conditions", low: 3, mid: 5, high: 8 },
    "03": { label: "Concrete (SOG/Foundation)", low: 27, mid: 49, high: 70 },
    "04": { label: "Masonry", low: 18, mid: 18, high: 18 },
    "05": { label: "Structural Steel", low: 78, mid: 78, high: 78 },
    "06": { label: "Wood & Plastics", low: 2, mid: 2, high: 2 },
    "07": { label: "Thermal & Moisture / Roofing", low: 29, mid: 29, high: 29 },
    "08": { label: "Openings (OH Doors)", low: 5, mid: 5, high: 5 },
    "09": { label: "Finishes", low: 4, mid: 10, high: 16 },
    21: { label: "Fire Suppression", low: 3, mid: 3, high: 3 },
    22: { label: "Plumbing", low: 0, mid: 3, high: 6 },
    23: { label: "HVAC", low: 0, mid: 3, high: 6 },
    26: { label: "Electrical (3-Phase)", low: 0, mid: 15, high: 25 },
    31: { label: "Earthwork", low: 19, mid: 24, high: 30 },
    32: { label: "Exterior / Paving", low: 10, mid: 18, high: 25 },
  },
  ...
  // Residential single-family — FROM 20 REAL NY PROJECTS ($300-$555-$920/SF)
  // Sources: Montana proposals + ProEst active/completed estimates (2024-2026)
  // Dunagan $632, East Jewett $821, Clausland $921, Novello #1 $302, Boghigian $342
  "residential-single": {
    "01": { label: "General Requirements", low: 18, mid: 41, high: 72 },
    "02": { label: "Existing Conditions/Demo", low: 3, mid: 7, high: 12 },
    "03": { label: "Concrete (Foundation/Slab)", low: 10, mid: 22, high: 42 },
    "04": { label: "Masonry", low: 3, mid: 5, high: 8 },
    "05": { label: "Structural Steel", low: 8, mid: 38, high: 85 },
    "06": { label: "Wood Framing & Finish Carpentry", low: 22, mid: 56, high: 98 },
    "07": { label: "Thermal & Moisture / Roofing", low: 18, mid: 52, high: 85 },
    "08": { label: "Windows & Doors", low: 20, mid: 35, high: 60 },
    "09": { label: "Finishes (Drywall, Paint, Tile, Flooring)", low: 35, mid: 55, high: 92 },
    10: { label: "Specialties", low: 2, mid: 4, high: 7 },
    11: { label: "Equipment / Appliances", low: 3, mid: 7, high: 12 },
    22: { label: "Plumbing", low: 15, mid: 20, high: 27 },
    23: { label: "HVAC", low: 15, mid: 29, high: 56 },
    26: { label: "Electrical", low: 15, mid: 28, high: 54 },
    31: { label: "Earthwork / Site", low: 12, mid: 20, high: 38 },
    32: { label: "Exterior Improvements", low: 10, mid: 23, high: 60 },
    33: { label: "Utilities", low: 6, mid: 10, high: 15 },
  },
  "mixed-use": {
  ...
  // Restaurant — FROM ACTUAL PROPOSALS (2 full GC projects, $649/SF mid)
  restaurant: {
    "01": { label: "General Requirements", low: 52, mid: 62, high: 72 },
    "02": { label: "Existing Conditions/Demo", low: 6, mid: 6, high: 6 },
    "03": { label: "Concrete", low: 18, mid: 30, high: 42 },
    "04": { label: "Masonry", low: 16, mid: 16, high: 16 },
    "05": { label: "Structural Steel", low: 36, mid: 36, high: 36 },
    "06": { label: "Wood, Plastics & Composites", low: 14, mid: 22, high: 31 },
    "07": { label: "Thermal & Moisture", low: 48, mid: 48, high: 48 },
    "08": { label: "Openings", low: 3, mid: 18, high: 33 },
    "09": { label: "Finishes (D&C, ACT, Paint, Tile, Flooring)", low: 34, mid: 51, high: 68 },
    10: { label: "Specialties (FRP, Bath Acc, Signage)", low: 8, mid: 8, high: 8 },
    12: { label: "Furnishings (Countertops, Casework)", low: 32, mid: 32, high: 32 },
    21: { label: "Fire Suppression", low: 13, mid: 13, high: 13 },
    22: { label: "Plumbing", low: 53, mid: 56, high: 58 },
    23: { label: "HVAC", low: 12, mid: 29, high: 47 },
    26: { label: "Electrical", low: 47, mid: 57, high: 68 },
    27: { label: "Communications", low: 3, mid: 3, high: 3 },
    28: { label: "Electronic Safety", low: 9, mid: 9, high: 9 },
    31: { label: "Earthwork", low: 58, mid: 58, high: 58 },
    32: { label: "Exterior Improvements", low: 91, mid: 91, high: 91 },
    33: { label: "Utilities", low: 3, mid: 3, high: 3 },
  },
  parking: {
