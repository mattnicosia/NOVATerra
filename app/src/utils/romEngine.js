...
const BENCHMARKS = {
  // Commercial office benchmarks — recalibrated 2024-2026 NY metro market
  "commercial-office": {
    "01": { label: "General Requirements", low: 8, mid: 15, high: 25 },
    "02": { label: "Existing Conditions/Demo", low: 2, mid: 6, high: 15 },
    "03": { label: "Concrete", low: 10, mid: 18, high: 30 },
    "04": { label: "Masonry", low: 3, mid: 8, high: 15 },
    "05": { label: "Structural Steel", low: 8, mid: 16, high: 28 },
    "06": { label: "Wood, Plastics & Composites", low: 4, mid: 10, high: 20 },
    "07": { label: "Thermal & Moisture", low: 5, mid: 10, high: 18 },
    "08": { label: "Openings", low: 6, mid: 12, high: 22 },
    "09": { label: "Finishes", low: 15, mid: 28, high: 45 },
    ...
    22: { label: "Plumbing", low: 6, mid: 12, high: 22 },
    23: { label: "HVAC", low: 12, mid: 22, high: 38 },
    26: { label: "Electrical", low: 10, mid: 18, high: 30 },
    27: { label: "Communications", low: 2, mid: 5, high: 10 },
    28: { label: "Electronic Safety", low: 2, mid: 5, high: 8 },
    31: { label: "Earthwork", low: 3, mid: 7, high: 14 },
    32: { label: "Exterior Improvements", low: 2, mid: 6, high: 12 },
    33: { label: "Utilities", low: 2, mid: 5, high: 10 },
  },
  ...
  healthcare: {
    ...
    "03": { label: "Concrete", low: 10, mid: 18, high: 30 },
    "05": { label: "Structural Steel", low: 8, mid: 15, high: 25 },
    "07": { label: "Thermal & Moisture", low: 5, mid: 10, high: 18 },
  ...
  industrial: {
    ...
    "05": { label: "Structural Steel", low: 10, mid: 18, high: 30 },
  ...
  "residential-multi": {
    ...
    "03": { label: "Concrete", low: 6, mid: 12, high: 20 },
    "05": { label: "Structural Steel", low: 3, mid: 6, high: 12 },
