...
const BENCHMARKS = {
  ...
  // Residential single-family — FROM ACTUAL MONTANA PROPOSALS (9 projects, $580/SF mid)
  // Crest House, Welcome Homes Katona, Broderick, 22 Adam Lane, etc.
  "residential-single": {
    "01": { label: "General Requirements", low: 6, mid: 43, high: 113 },
    "02": { label: "Existing Conditions/Demo", low: 1, mid: 7, high: 14 },
    "03": { label: "Concrete (Foundation/Slab)", low: 1, mid: 23, high: 63 },
    "04": { label: "Masonry", low: 1, mid: 5, high: 10 },
    "05": { label: "Structural Steel", low: 4, mid: 40, high: 132 },
    "06": { label: "Wood Framing & Finish Carpentry", low: 3, mid: 59, high: 121 },
    "07": { label: "Thermal & Moisture / Roofing", low: 6, mid: 54, high: 130 },
    "08": { label: "Windows & Doors", low: 20, mid: 37, high: 94 },
    "09": { label: "Finishes (Drywall, Paint, Tile, Flooring)", low: 23, mid: 58, high: 144 },
    10: { label: "Specialties", low: 2, mid: 4, high: 7 },
    11: { label: "Equipment / Appliances", low: 1, mid: 7, high: 15 },
    22: { label: "Plumbing", low: 15, mid: 21, high: 27 },
    23: { label: "HVAC", low: 4, mid: 30, high: 87 },
    26: { label: "Electrical", low: 5, mid: 29, high: 84 },
    31: { label: "Earthwork / Site", low: 2, mid: 21, high: 39 },
    32: { label: "Exterior Improvements", low: 4, mid: 24, high: 94 },
