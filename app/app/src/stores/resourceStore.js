...
export const useResourceStore = create(set => ({
  ...
  // Workload view mode
  sortMode: "field", // "field" | "board" | "timeline" | "hours" | "due-date" | "weekly" | "analytics"
  ...
  clearDragState: () =>
    set({ dragEstimateId: null, dragOverEstimator: null, dragMode: null, dragDaysDelta: 0, dragOriginalBidDue: "" }),
}));
