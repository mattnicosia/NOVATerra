    ...
    <div style={{ padding: "14px 16px", height: "100%", display: "flex", flexDirection: "column" }}>
      ...
      {upcoming.length === 0 ? (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6, flex: 1, overflow: "auto" }}>
          {upcoming.map(e => {
            const urgencyColor =
              e.daysLeft <= 0 ? C.red : e.daysLeft <= 3 ? C.red : e.daysLeft <= 7 ? C.orange : C.green;
            ...
            return (
              <div
                ...
                onMouseEnter={e2 => {
                  e2.currentTarget.style.background = dk ? `${urgencyColor}15` : `${urgencyColor}12`;
                }}
                onMouseLeave={e2 => {
                  e2.currentTarget.style.background = dk ? `${urgencyColor}08` : `${urgencyColor}06`;
                }}
              >
                {/* Countdown badge */}
                <div
